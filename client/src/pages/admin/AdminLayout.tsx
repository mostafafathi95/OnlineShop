...
const navigation = [
  ...
  { name: "ویژگی‌های محصول", href: "/admin/attributes", icon: Zap },
  { name: "روش‌های ارسال", href: "/admin/shipping", icon: TrendingUp },
  { name: "نقاط اعتباری", href: "/admin/credits", icon: Zap },
  { name: "کیف‌پول کاربران", href: "/admin/wallets", icon: Wallet },
