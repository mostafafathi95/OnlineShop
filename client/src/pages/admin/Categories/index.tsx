...
import { useCategoryForm, useCategories, parseCategoryForEdit } from "./hooks";
import { useCreateCategoryMutation, useUpdateCategoryMutation, useDeleteCategoryMutation } from "./mutations";
...
export default function AdminCategories() {
  ...
  const { formData, setFormData, resetForm } = useCategoryForm();
  ...
  const handleEdit = (category: Category) => {
    ...
    setFormData(parseCategoryForEdit(category));
